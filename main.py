...
def cmd_help(args):
    print("Enterprise DLP + Data Classification")
    print("")
    print("子命令: serve (启动 FastAPI on 端口 5037)")
    print("更多子命令待开发（参考 docs/PRD.md 第 3 章节 Prompt）")


def main():
    parser = argparse.ArgumentParser(description="Enterprise DLP + Data Classification")
